...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default=r"C:\Users\mrcry\Documents\weight\best_all_36.pt", help='weight file path')
    parser.add_argument('--visiual', type=str, default=r'C:\Users\mrcry\Documents\yolo-v3-36\data\test', help='test data path or None')
